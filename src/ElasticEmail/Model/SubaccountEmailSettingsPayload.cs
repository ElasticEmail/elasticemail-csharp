...
namespace ElasticEmail.Model
{
    ...
    public partial class SubaccountEmailSettingsPayload : IEquatable<SubaccountEmailSettingsPayload>, IValidatableObject
    {
        ...
        public SubaccountEmailSettingsPayload(bool requiresEmailCredits = default(bool), int emailSizeLimit = default(int), int dailySendLimit = default(int), int maxContacts = default(int), bool enablePrivateIPPurchase = default(bool), string poolName = default(string))
        {
