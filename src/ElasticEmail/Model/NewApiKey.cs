...
namespace ElasticEmail.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewApiKey")]
    public partial class NewApiKey : IEquatable<NewApiKey>, IValidatableObject
    {
        /// <summary>
        ...
        public NewApiKey(string token = default(string), List<AccessLevel> accessLevel = default(List<AccessLevel>), string name = default(string), DateTime dateCreated = default(DateTime), DateTime? lastUse = default(DateTime?), DateTime? expires = default(DateTime?), List<string> restrictAccessToIPRange = default(List<string>))
        {
            this.Token = token;
        ...
        {
            return this.Equals(input as NewApiKey);
        }

        /// <summary>
        /// Returns true if NewApiKey instances are equal
        /// </summary>
        /// <param name="input">Instance of NewApiKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewApiKey input)
        {
            if (input == null)
                return false;
