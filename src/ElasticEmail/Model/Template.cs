...
namespace ElasticEmail.Model
{
    ...
    public partial class Template : IEquatable<Template>, IValidatableObject
    {
        ...
        public Template(TemplateType? templateType = default(TemplateType?), string name = default(string), DateTime dateAdded = default(DateTime), string subject = default(string), List<BodyPart> body = default(List<BodyPart>), TemplateScopeType? templateScope = default(TemplateScopeType?))
        {
