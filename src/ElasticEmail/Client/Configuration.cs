...
namespace ElasticEmail.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "4.0.28";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/4.0.28/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.elasticemail.com/v4") : this()
        {
        ...
        {
            string report = "C# SDK (ElasticEmail) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 4.0.0\n";
            report += "    SDK Package Version: 4.0.28\n";
